...
class Builder extends AbstractBuilder
{
    ...
    /**
     * @param SqlInterface|ExpressionInterface $object
    ...
    /**
     * @param SqlInterface|ExpressionInterface $sqlObject
    ...
    protected function build($sqlObject, Context $context)
    {
        ...
        if (!$sqlObject instanceof SqlInterface && !$sqlObject instanceof ExpressionInterface) {
            throw new \Zend\Db\Sql\Exception\InvalidArgumentException(sprintf(
                ...
                __METHOD__ . '()',
                'Zend\Db\Sql\SqlInterface or Zend\Db\Sql\ExpressionInterface',
        ...
        if (isset($specAndParams[$this->implodeGlueKey])) {
            ...
            $implodeGlue = $sqlObject instanceof SqlInterface ? ' ' : '';
        }
