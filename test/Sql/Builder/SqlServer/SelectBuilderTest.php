...
namespace ZendTest\Db\Sql\Builder\SqlServer;

use Zend\Db\Sql\Builder\SqlServer\SelectBuilder;
...
{
    /**
     * @testdox integration test: Testing SelectBuilder will use Select an internal state to prepare a proper limit/offset sql statement
    ...
    /**
     * @testdox integration test: Testing SelectBuilder will use Select an internal state to prepare a proper limit/offset sql statement
     * @covers Zend\Db\Sql\Platform\SqlServer\SelectBuilder::getSqlString
     * @covers Zend\Db\Sql\Platform\SqlServer\SelectBuilder::processLimitOffset
     * @dataProvider dataProvider
     */
