...
namespace ZendTest\Db\Sql\Builder\Oracle;

use Zend\Db\Sql\Builder\Oracle\SelectBuilder;
...
class SelectBuilderTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @testdox integration test: Testing SelectBuilder will use Select to produce properly Oracle dialect prepared sql
     * @covers Zend\Db\Sql\Platform\SqlServer\SelectBuilder::prepareStatement
     * @covers Zend\Db\Sql\Platform\SqlServer\SelectBuilder::processLimitOffset
    ...
    public function testPrepareStatement(
        ...
        $selectDecorator = new SelectBuilder;
    ...
    // @codingStandardsIgnoreStart
    /**
     * @testdox integration test: Testing SelectBuilder will use Select to produce properly Oracle dialect sql statements
     * @covers Zend\Db\Sql\Platform\Oracle\SelectBuilder::getSqlString
     * @dataProvider dataProvider
     */
    // @codingStandardsIgnoreEnd
